            ...
            children: [
              Row(
                children: [
                  ...
                  CustomButton(
                      onPressed: () {
                        Message.info(context, Icons.create,
                            '操作${widget.data.projectName}');

                        versionStore
                            .getVersionList({'repo_id': widget.data.id});

                        GoRouter.of(context).pushNamed(
                          AppRoutes.versionManaNamed,
                          extra: {
                            'name': widget.data.projectName,
                            'id': widget.data.id,
                          },
                        );
                      },
                  ...
                  DangerButton(
                      onPressed: () {
                        ...
                        Message.error(context, Icons.delete,
                            '操作${widget.data.projectName}');
                      },
                      name: '删除'),
                  const SizedBox(width: 10),
